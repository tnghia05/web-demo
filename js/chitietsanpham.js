...
function phanTich_URL_chiTietSanPham() {
    ...
    function timKiemTheoMaa(list_products, maProduct) {
        for (var i = 0; i < list_products.length; i++) {
            if (list_products[i].masp === maProduct) {
                return list_products[i];
            }
        }
    ...
    sanPhamHienTai = timKiemTheoMaa(list_products, maProduct);
